...
class decisionTree:
    ...
    def buildTree(self, rows, entropyFun=entropy):
        ...
        if (best_gain > 0):
            ...
            return decisionNode(col=best_criteria[0], value=best_criteria[1], trueBranch=trueBranch,
...
# print the tree
treeClass.printTree(tree, ['Family Members', 'Salary', 'Marital Status', 'Inquiries', 'Flat Type'])
